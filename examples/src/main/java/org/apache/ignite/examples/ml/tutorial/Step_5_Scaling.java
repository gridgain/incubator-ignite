    ...
    public static void main(String[] args) {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            try {
                ...
                Preprocessor strEncoderPreprocessor = new EncoderTrainer<Integer, Vector>()
                ...
                Preprocessor imputingPreprocessor = new ImputerTrainer<Integer, Vector>()
                    .fit(ignite,
                        dataCache,
                        strEncoderPreprocessor
                    );

                Preprocessor minMaxScalerPreprocessor = new MinMaxScalerTrainer<Integer, Vector>()
                    .fit(
                        ignite,
                        dataCache,
                ...
                Preprocessor normalizationPreprocessor = new NormalizationTrainer<Integer, Vector>()
                    .withP(1)
                    .fit(
                        ignite,
                        dataCache,
