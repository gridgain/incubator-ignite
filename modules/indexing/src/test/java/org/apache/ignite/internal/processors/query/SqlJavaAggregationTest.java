 ...
 */
public class SqlJavaAggregationTest extends GridCommonAbstractTest {
    ...
    public void javaAggregationFunction() throws Exception {
        ...
        indexing.prepareNativeStatement(null,"CREATE AGGREGATE IF NOT EXISTS ACCUMULATE FOR \"" + AccumulateFunction.class.getName() + "\"").execute();
