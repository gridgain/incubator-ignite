...
public class FunctionalQueryTest {
    ...
    public void testSql() throws Exception {
        try (Ignite ignored = Ignition.start(Config.getServerConfiguration());
             IgniteClient client = Ignition.startClient(new IgniteClientConfiguration().setAddresses(Config.SERVER))
        ) {
            client.query(
    ...
    private static IgniteClientConfiguration getClientConfiguration() {
        return new IgniteClientConfiguration().setAddresses(Config.SERVER)
            .setSendBufferSize(0)
