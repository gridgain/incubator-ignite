...
/**
 * Index min version search row.
 */
public class GridH2MvccMinVersionSearchRow extends GridH2SearchRowAdapter {
    /** */
    private GridH2SearchRow row;

    /** {@inheritDoc} */
    public GridH2MvccMinVersionSearchRow(GridH2SearchRow row) {
        this.row = row;
    }
