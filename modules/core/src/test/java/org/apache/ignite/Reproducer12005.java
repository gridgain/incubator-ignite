...
public class Reproducer12005 extends GridCommonAbstractTest {
    ...
    public void test() throws Exception {
        ...
        FilePageStore store = (FilePageStore)storeFactory.createPageStore(FLAG_DATA, partFile, new LongAdderMetric("asd", "zxc"));
