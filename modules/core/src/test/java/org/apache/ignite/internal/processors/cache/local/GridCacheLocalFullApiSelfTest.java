...
public class GridCacheLocalFullApiSelfTest extends GridCacheAbstractFullApiSelfTest {
    ...
    public void testMapKeysToNodes() throws Exception {
        ...
        Map<ClusterNode, Collection<String>> map = ignite(0).<String>affinity(DEFAULT_CACHE_NAME).mapKeysToNodes(F.asList("key1", "key2"));
        ...
        map = ignite(0).<String>affinity(DEFAULT_CACHE_NAME).mapKeysToNodes(F.asList("key1", "key2"));
