...
import org.apache.ignite.thinclient.Person;
...
public class IgniteBinaryTest {
    ...
    public void testBinaryConfigurationAllowsUnmarshalSchemalessIgniteBinaries() throws Exception {
        ...
        try (Ignite srv = Ignition.start(Config.getServerConfiguration())) {
            ...
            // does not register schema in the client. Thus, unmarshalling this value would not work without
    ...
    public void testBinaryObjectPutGet() throws Exception {
        ...
        try (Ignite ignored = Ignition.start(Config.getServerConfiguration())) {
            try (IgniteClient client =
                     Ignition.startClient(new IgniteClientConfiguration().setAddresses(Config.SERVER))
            ) {
        ...
        return new IgniteClientConfiguration()
            ...
            .setBinaryConfiguration(new BinaryConfiguration()
                .setTypeConfigurations(Collections.singletonList(
                    new BinaryTypeConfiguration(Person.class.getName())
                ))
            );
    }
