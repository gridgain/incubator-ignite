...
import org.apache.ignite.internal.thinclient.ClientServerError;
import org.apache.ignite.thinclient.IgniteUnavailableException;
import org.apache.ignite.thinclient.LocalIgniteCluster;
...
public class ReliabilityTest {
    ...
    public void testFailover() throws Exception {
        ...
        try (LocalIgniteCluster cluster = LocalIgniteCluster.start(CLUSTER_SIZE);
             IgniteClient client = Ignition.startClient(new IgniteClientConfiguration()
            ...
            try {
                ...
                assertTrue(Stream.of(suppressed).allMatch(t -> t instanceof IgniteUnavailableException));
            }
