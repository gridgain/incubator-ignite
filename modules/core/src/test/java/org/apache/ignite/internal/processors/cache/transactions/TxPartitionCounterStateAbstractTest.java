...
public abstract class TxPartitionCounterStateAbstractTest extends GridCommonAbstractTest {
    ...
    @Override protected IgniteConfiguration getConfiguration(String igniteInstanceName) throws Exception {
        ...
        cfg.setFailureDetectionTimeout(10000000000000L);
        cfg.setClientFailureDetectionTimeout(10000000000000L);
    ...
    /**
     * @return {@code True} if persistence should be enabled for test class.
     */
