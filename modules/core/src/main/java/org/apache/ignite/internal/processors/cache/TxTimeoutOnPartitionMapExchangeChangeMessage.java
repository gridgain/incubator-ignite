...
public class TxTimeoutOnPartitionMapExchangeChangeMessage implements DiscoveryCustomMessage {
     ...
     */
    public TxTimeoutOnPartitionMapExchangeChangeMessage(TxTimeoutOnPartitionMapExchangeChangeMessage request) {
     ...
     */
    public TxTimeoutOnPartitionMapExchangeChangeMessage(UUID requestId, long timeout) {
