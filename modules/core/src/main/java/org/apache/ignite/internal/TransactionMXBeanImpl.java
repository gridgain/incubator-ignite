...
/**
 * Transaction management MBean implementation.
 */
public class TransactionMXBeanImpl implements TransactionMXBean {
    /** Grid kernal context. */
     ...
     */
    public TransactionMXBeanImpl(GridKernalContext ctx) {
        assert ctx != null;
