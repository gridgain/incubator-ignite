 ...
 * <p>
 * Unlike some other languages Java does not have a native understanding of JSON. To enable JSON to be used easily in
 * Vert.x code we use this class to encapsulate the notion of a JSON array.
 *
...
public class JsonArray implements Iterable<Object> {
     ...
     * encoded binary, which it decodes if found and returns.
     * <p>
    ...
    /**
     * Does the JSON array contain the specified value? This method will scan the entire array until it finds a value or
     * reaches the end.
     *
     * @param value the value
    ...
    /**
     * Remove the specified value from the JSON array. This method will scan the entire array until it finds a value or
     * reaches the end.
     *
