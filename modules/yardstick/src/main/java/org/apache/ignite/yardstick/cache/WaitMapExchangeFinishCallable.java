        ...
        for (IgniteInternalCache<?, ?> cache : cachesx) {
            try {
                ...
                for (;;) {
                    ...
                    if (top.readyAffinityVersion().topologyVersion() == ignite.cluster().topologyVersion()) {
                        ...
                        BenchmarkUtils.println("Topology version is different [cache=" + top.readyAffinityVersion() +
