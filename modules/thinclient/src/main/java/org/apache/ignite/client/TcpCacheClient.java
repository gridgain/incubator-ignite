...
class TcpCacheClient<K, V> implements CacheClient<K, V> {
    ...
    /** Constructor. */
    TcpCacheClient(String name, ReliableChannel ch) {
        this.name = name;
    ...
    /** {@inheritDoc} */
    @Override public int size(CachePeekMode... peekModes) throws IgniteClientException {
        return ch.service(
    ...
    /** {@inheritDoc} */
    @Override public Map<K, V> getAll(Set<? extends K> keys) throws IgniteClientException {
        if (keys == null)
    ...
    /** {@inheritDoc} */
    @Override public void putAll(Map<? extends K, ? extends V> map) throws IgniteClientException {
        if (map == null)
    ...
    /** {@inheritDoc} */
    @Override public boolean replace(K key, V oldVal, V newVal) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public boolean replace(K key, V val) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public boolean remove(K key) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public boolean remove(K key, V oldVal) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public void removeAll(Set<? extends K> keys) throws IgniteClientException {
        if (keys == null)
            throw new NullPointerException("keys");
    ...
    /** {@inheritDoc} */
    @Override public void removeAll() throws IgniteClientException {
        ch.request(ClientOperation.CACHE_REMOVE_ALL, this::writeCacheInfo);
    }

    /** {@inheritDoc} */
    @Override public V getAndPut(K key, V val) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public V getAndRemove(K key) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public V getAndReplace(K key, V val) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public boolean putIfAbsent(K key, V val) throws IgniteClientException {
        if (key == null)
            throw new NullPointerException("key");
    ...
    /** {@inheritDoc} */
    @Override public void clear() throws IgniteClientException {
        ch.request(ClientOperation.CACHE_CLEAR, this::writeCacheInfo);
    }

    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    @Override public <K1, V1> CacheClient<K1, V1> withKeepBinary() {
        TcpCacheClient<K1, V1> binCache;

        if (keepBinary) {
            try {
                binCache = (TcpCacheClient<K1, V1>)this;
            }
            ...
            binCache = new TcpCacheClient<>(name, ch);
