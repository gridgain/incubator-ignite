...
public class IgniteClientException extends Exception {
     ...
     */
    IgniteClientException(SystemEvent evt) {
        this.evt = evt;
    }
     ...
     */
    IgniteClientException(SystemEvent evt, String msg) {
        super(msg);
     ...
     */
    IgniteClientException(SystemEvent evt, Throwable cause) {
        super(cause);
     ...
     * @param cause the cause.
     */
    IgniteClientException(SystemEvent evt, String msg, Throwable cause) {
        super(msg, cause);
