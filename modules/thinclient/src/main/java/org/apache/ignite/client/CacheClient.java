...
public interface CacheClient<K, V> {
     ...
     */
    public int size(CachePeekMode... peekModes) throws IgniteClientException;

    /**
     * Gets a collection of entries from the {@link CacheClient}, returning them as
     ...
     */
    public Map<K, V> getAll(Set<? extends K> keys) throws IgniteClientException;

    /**
     * Copies all of the entries from the specified map to the {@link CacheClient}.
     * <p>
     ...
     */
    public void putAll(Map<? extends K, ? extends V> map) throws IgniteClientException;
     ...
     */
    public boolean replace(K key, V oldVal, V newVal) throws IgniteClientException;
     ...
     * @return <tt>true</tt> if the value was replaced.
     */
    public boolean replace(K key, V val) throws IgniteClientException;
     ...
     */
    public boolean remove(K key) throws IgniteClientException;
     ...
     * @return <tt>false</tt> if there was no matching key.
     */
    public boolean remove(K key, V oldVal) throws IgniteClientException;
     ...
     */
    public void removeAll(Set<? extends K> keys) throws IgniteClientException;
     ...
     */
    public void removeAll() throws IgniteClientException;
     ...
     */
    public V getAndPut(K key, V val) throws IgniteClientException;
     ...
     */
    public V getAndRemove(K key) throws IgniteClientException;
     ...
     */
    public V getAndReplace(K key, V val) throws IgniteClientException;
     ...
     */
    public boolean putIfAbsent(K key, V val) throws IgniteClientException;

    /**
     * Clears the contents of the cache.
     */
    public void clear() throws IgniteClientException;
     ...
     */
    public <K1, V1> CacheClient<K1, V1> withKeepBinary();
